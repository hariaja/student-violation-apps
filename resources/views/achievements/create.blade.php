...
<div class="block block-rounded">
  ...
  <div class="block-content block-content-full">
    ...
    <form action="{{ route('achievements.store') }}" method="POST" onsubmit="return disableSubmitButton()">
      @csrf
      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="{{ trans('Nama Prestasi') }}" onkeypress="return onlyLetter(event)">
            @error('name')
          ...
          <div class="mb-4">
            ...
            <span class="text-danger">*</span>
            <input type="number" min="1" max="25" step="0.5" name="point" id="point" class="form-control @error('point') is-invalid @enderror" value="{{ old('point') }}" required placeholder="{{ trans('Point Prestasi') }}">
